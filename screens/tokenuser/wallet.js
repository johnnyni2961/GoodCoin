...
export default class Wallet extends React.Component  {
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:20,marginTop:'10%',marginLeft:'5%', textAlign:'left', color:'#fff', fontFamily:'FuturaH', marginBottom:'10%'}}>Available Tokens                             <Icon  name='history' color='#fff'onPress={()=>this.props.navigation.navigate('THistory')}></Icon> <Icon onPress={()=>this.props.navigation.navigate('THome')}  name='home' color='#fff'></Icon></Text>
      <ScrollView>
      <WalletItemList itemList={this.getData()}/>
      </ScrollView>
