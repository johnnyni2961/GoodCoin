...
export default class Reg extends React.Component  {
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <TextInput placeholder='Username' style={{position:'relative',fontSize:20,margin:'auto', paddingLeft:'5%', color:'#798497', fontFamily:'FuturaL', marginTop:'30%', backgroundColor:'#EAEAEA',padding:'2.5%', width:'80%', borderRadius:5,alignSelf:'center'}}></TextInput>
      ...
      <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#c0a188', fontFamily:'FuturaH', marginTop:'15%', backgroundColor:'#000', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>{this.props.navigation.navigate('Login');}}>REGISTER</Text>
