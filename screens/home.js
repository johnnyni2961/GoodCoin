...
export default class Home extends React.Component  {
  ...
  render(){
    ...
    <Text style={{position:'relative',fontSize:20,textAlign:'center', color:'#000', fontFamily:'FuturaH', marginBottom:'5%', backgroundColor:'#FFF', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:5,borderColor:'#c0a188', borderWidth:1,}} >Generate ${this.state.token} Token</Text>
