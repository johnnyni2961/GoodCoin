...
export default function WalletItem({ route,txid,date,token, food, accomodation, services, supplies}) {
...
<Text style={{position:'relative',fontSize:20,marginTop:'1.5%',marginBottom:'10%',alignSelf:'center', width:'70%', textAlign:'center', color:'#000',borderRadius:10, paddingVertical:'5%', fontFamily:'FuturaH', backgroundColor:'#c0a188'}}>USE TOKEN</Text>
</View>
)}
